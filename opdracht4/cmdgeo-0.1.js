...
(function(){
    ...
    var positionFunctions = {
        ...
        init: function (){
            ...
            ET.addListener(constants.GPS_AVAILABLE, _start_interval);
        ...
        _start_interval: function (event){
            ...
            _update_position();
            interval = self.setInterval(_update_position, constants.REFRESH_RATE);
            ET.addListener(constants.POSITION_UPDATED, _check_locations);
        },
    ...
    EventTarget.prototype={
        ...
        fire:function(a){
            ...
            if(this._listeners[a.type]instanceof Array)for(
        ...
        removeListener:function(a,c){
            if(this._listeners[a]instanceof Array)for(
                var b= this._listeners[a],d=0,e=b.length;
                d<e;d++)
            if(b[d]===c){
                b.splice(d,1);break
            }
    ...
    var mapsFunctions = {
        ...
        // TODO: Kleur aanpassen op het huidige punt van de tour
            ...
            ET.addListener(constants.POSITION_UPDATED, update_positie);
        },
